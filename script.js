const STROKES = {
  ...
  "Derecha": ["cruzada", "paralela", "centro", "globo"],
  "Revés": ["cruzada", "paralela", "centro", "globo"],
  "Volea": ["alta", "baja", "cruzada", "paralela"],
  "Esp red": ["bandeja", "x3", "remate", "rulo"],
  "Esp fondo": ["bajada", "chiquita", "contrarremate", "globo cristal"]
};
